...
PlayerFlags = ["PLAYING", "IN_MENU", "CHATTING", "SCOREBOARD", "AIM", "ZClient", "EMPTY", "EMPTY2", "EMPTY3", "EMPTY4", "EMPTY5"] ## EMPTY flags so that no collisions between different clients can happen
