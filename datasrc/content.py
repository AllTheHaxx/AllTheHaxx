...
image_luaicons = Image("luaicons", "lua_icons.png")
...
container.images.Add(image_luaicons)
...
set_luaicons = SpriteSet("luaicons", image_luaicons, 2, 1)
...
container.spritesets.Add(set_luaicons)
...
container.sprites.Add(Sprite("lua_debug", set_luaicons, 0,0,1,1))
container.sprites.Add(Sprite("lua_profiler", set_luaicons, 1,0,1,1))
