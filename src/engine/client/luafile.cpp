...
{		
	getGlobalNamespace(L)
		...
		.beginClass< LuaCUIRect >("UIRect")
			.addConstructor <void (*) (float, float, float, float)> ()
			.addData("x", &LuaCUIRect::x)
			.addData("y", &LuaCUIRect::y)
			.addData("w", &LuaCUIRect::w)
			.addData("h", &LuaCUIRect::h)
			.addFunction("HSplitMid", &LuaCUIRect::HSplitMid)
			.addFunction("HSplitTop", &LuaCUIRect::HSplitTop)
			.addFunction("HSplitBottom", &LuaCUIRect::HSplitBottom)
			.addFunction("VSplitMid", &LuaCUIRect::HSplitMid)
			.addFunction("VSplitLeft", &LuaCUIRect::VSplitLeft)
			.addFunction("VSplitRight", &LuaCUIRect::VSplitRight)
			.addFunction("Margin", &LuaCUIRect::Margin)
			.addFunction("VMargin", &LuaCUIRect::VMargin)
			.addFunction("HMargin", &LuaCUIRect::HMargin)
		.endClass()
