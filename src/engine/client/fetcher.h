...
public:
	...
	virtual IFetchTask *FetchFile(const char *pUrl, const char *pDest, int StorageType = -2, bool CanTimeout = true, void *pUser = 0, COMPFUNC pfnCompCb = 0, PROGFUNC pfnProgCb = 0);
