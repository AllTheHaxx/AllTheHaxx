...
int CGraphics_Threaded::IssueInit()
{
	...
	return m_pBackend->Init("Teeworlds AllTheHaxx - VERKECKT ~ by xush' and Henritees", &g_Config.m_GfxScreenWidth, &g_Config.m_GfxScreenHeight, g_Config.m_GfxFsaaSamples, Flags);
}
