...
#define ATH_VERSION "0.30.2"
#define DDNET_VERSION "10.6.2"
#define BUILD_DATE __DATE__ ", " __TIME__

#if defined(FEATURE_LUA)
#define ALLTHEHAXX_VERSIONID ATH_VERSION
#else
#define ALLTHEHAXX_VERSIONID ATH_VERSION "-NL"
#endif
