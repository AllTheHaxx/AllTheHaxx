...
MACRO_CONFIG_INT(ClIRCShowJoins, cl_irc_show_joins, 1, 0, 2, CFGFLAG_CLIENT|CFGFLAG_SAVE, "0: hide all joins/leaves | 1: show in chat | 2: show in chat and notifications")
