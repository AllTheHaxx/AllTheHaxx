...
MACRO_CONFIG_STR(ClDDNetVersionServer, cl_ddnet_version_server, 100, "version.ddnet.tw", CFGFLAG_CLIENT|CFGFLAG_SAVE, "Server to sync ddnet version (needed for DDNet-Serverlist)")
...
MACRO_CONFIG_INT(UiPage, ui_page, 7, 0, 13, CFGFLAG_CLIENT|CFGFLAG_SAVE, "Interface page")
